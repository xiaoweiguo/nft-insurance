...
contract DAO is Ownable, ERC20, IDAO, AutomationCompatibleInterface {
  ...
  modifier onlyDaoMember() {
    require(isStakeholder[msg.sender] == true, "Not a DAO member");
    _;
  }
  ...
  function withdraw(uint stakingAmount) external onlyDaoMember {
  ...
  function vote(uint proposalId) external onlyDaoMember {
